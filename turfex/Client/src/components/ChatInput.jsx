        ...
        <option value="french">French</option>
          ...
          <div className="relative" ref={modelRef}>
            <button
              ...
              className="inline-flex mt-0.5 justify-center items-center rounded-full border border-black px-4 py-2 bg-white text-sm font-medium text-black hover:bg-gray-100"
            >
              {selectedModel}
            ...
            {showOptions && (
              ...
              className="absolute z-10 bottom-full mt-1 w-48 rounded-md shadow-lg bg-white mb-3.5 ring-opacity-5">
                  ...
                  <button disabled className="block w-full py-2 text-left text-gray-400 cursor-not-allowed">
                    GPT-4 (coming soon)
                  </button>
