...
export function HomePage(){
    return(
      ...
      <div className="absolute top-0 left-0 w-28 h-28 bg-[#F0E4D3] rounded-br-full z-0"></div>
      <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#DCC5B2] rounded-tl-full z-0"></div>
