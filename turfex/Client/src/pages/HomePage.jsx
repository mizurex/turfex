...
export function HomePage(){
    return(
         <div className="relative bg-[#fdfdfd] min-h-screen overflow-hidden font-sans flex flex-col justify-center items-center px-4">
      {/* Background yellow blobs */}
      <div className="absolute top-0 left-0 w-28 h-28 bg-black rounded-br-full z-0"></div>
      <div className="absolute bottom-0 right-0 w-32 h-32 bg-yellow-400 rounded-tl-full z-0"></div>
      <div className="absolute top-0 right-0 w-7 h-9 bg-yellow-400 rounded-tl-full z-0"></div>

      {/* Floating background icons */}
      <div className="absolute bottom-16 left-10 opacity-10 z-0">
        <MessageCircle className="w-6 h-6 text-black" />
      </div>
      <div className="absolute bottom-28 right-40 opacity-10 z-0">
        <User className="w-6 h-6 text-black" />
      </div>

     
      <svg
        className="absolute bottom-20 right-16 w-72 h-[500px] opacity-5 z-0"
        viewBox="0 0 200 400"
        fill="none"
        stroke="black"
        strokeWidth="1"
      ...
      <div className="relative z-10 bg-white shadow-2xl mt-6 px-10 py-10 w-full max-w-7xl rounded-2xl">
        ...
        <div className="flex items-center justify-between mb-10">
          <div className="flex items-center gap-2">
            <div className="bg-black text-white rounded-full px-2 py-1 text-xs font-bold">turfex</div>
 ...
 <h2 className="text-center text-3xl font-bold mb-12 text-black">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div className="flex flex-col items-center text-center bg-[#fffbea] p-6 rounded-xl shadow-sm hover:shadow-md transition">
      <div className="bg-yellow-400 text-black w-14 h-14 flex items-center justify-center rounded-full mb-4">
    ...
    <div className="flex flex-col items-center text-center bg-[#fffbea] p-6 rounded-xl shadow-sm hover:shadow-md transition">
      ...
      <p className="text-sm text-gray-700">No tracking. No ads. Just your conversation, your way.</p>
    </div>
  </div>
</section>
      ...
      {/* Footer */}
      <footer className="mt-8 text-center text-xs text-gray-400 z-10">
        © 2025 Turfex AI • <a href="#" className="underline">GitHub</a> • <a href="#" className="underline">Terms</a>
      </footer>
    </div>
    )
}